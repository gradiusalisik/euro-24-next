  ...
  },
  {
    ...
    advantages: [
      ...
      },
      {
        id: "3",
        icon: <Cold />,
        title: "Доступная стоимостьв своем сегменте.",
        description:
      ...
      },
      {
        ...
        title: "Простой уход.",
        description:
          "Гладкая поверхностьматериала профиля обеспечивает простоту ухода за окнами."
      }
    ]
  },
  {
    ...
    advantages: [
      ...
      },
      {
        ...
        description:
          "Пластиковые окна Трокаль не утрачивают своих замечательных свойств даже при температуре – 60 по Цельсию, что делает их незаменимыми в северных широтах нашей страны."
      },
      {
        id: "3",
        icon: <Cold />,
